...
use webshopBundle\Entity\customer;
...
class customerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $customers = $em->getRepository('webshopBundle:customer')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('webshopBundle\Form\customerType', $customer);
    ...
    {
        $deleteForm = $this->createDeleteForm($customer);
        $editForm = $this->createForm('webshopBundle\Form\customerType', $customer);
