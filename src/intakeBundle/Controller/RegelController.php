...
class RegelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $regels = $em->getRepository('intakeBundle:Regel')->findAll();
        return $this->render('intakeBundle:regel:index.html.twig', array(
            'regels' => $regels,
        ));
    }
    /**
    ...
    {
        $regel = new Regel();
        $form = $this->createForm('intakeBundle\Form\RegelType', $regel);
        ...
        return $this->render('intakeBundle:regel:new.html.twig', array(
            'regel' => $regel,
    ...
    public function showAction(Regel $regel)
    {
        ...
        return $this->render('intakeBundle:row:show.html.twig', array(
            'regel' => $regel,
    ...
    {
        $deleteForm = $this->createDeleteForm($regel);
        $editForm = $this->createForm('intakeBundle\Form\RegelType', $regel);
        $editForm->handleRequest($request);
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();
            return $this->redirectToRoute('regel_edit', array('id' => $regel->getId()));
        }
        return $this->render('intakeBundle:row:edit.html.twig', array(
            'regel' => $regel,
