...
use intakeBundle\Entity\customer;
...
class customerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $customers = $em->getRepository('intakeBundle:customer')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('intakeBundle\Form\customerType', $customer);
    ...
    {
        $deleteForm = $this->createDeleteForm($customer);
        $editForm = $this->createForm('intakeBundle\Form\customerType', $customer);
