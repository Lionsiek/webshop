...
class FactuurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        if ($this->get('security.authorization_checker')->isGranted('ROLE_ADMIN')) {
            $invoices = $em->getRepository('intakeBundle:Factuur')->findAll();
        } else {
            $invoices = $em->getRepository('intakeBundle:Factuur')->findBy(['userId' => $this->getUser()]);
        }
        return $this->render('intakeBundle:invoice:index.html.twig', array(
            'factuurs' => $invoices,
        ));
    }
    /**
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('intakeBundle\Form\FactuurType', $invoice);
        ...
        return $this->render('intakeBundle:invoice:new.html.twig', array(
            'factuur' => $invoice,
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $regels = $em->getRepository('intakeBundle:Regel')->findby(['factuurId' => $invoice->getId()]);
...
//         die();
        ...
        return $this->render('intakeBundle:invoice:show.html.twig', array(
            'factuur' => $invoice,
            'products' => $products,
            'regels' => $regels,
            'users' => $users,
    ...
    public function editAction(Request $request, Factuur $invoice)
    {
        ...
        $deleteForm = $this->createDeleteForm($invoice);
        $editForm = $this->createForm('intakeBundle\Form\FactuurType', $invoice);
        ...
        return $this->render('intakeBundle:invoice:edit.html.twig', array(
            'factuur' => $invoice,
            'products' => $products,
