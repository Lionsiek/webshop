 ...
 * @ORM\Entity(repositoryClass="intakeBundle\Repository\RegelRepository")
 */
class Regel
{
    /**
    ...
    /**
     *
     * @ORM\ManyToOne(targetEntity="intakeBundle\Entity\Factuur")
    ...
    /**
     *
     * @ORM\ManyToOne(targetEntity="intakeBundle\Entity\products")
